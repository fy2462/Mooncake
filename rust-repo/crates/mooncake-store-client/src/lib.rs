...
pub use client::{
    ...
    ClientBackgroundHandle, ClientHealthStatus, ClientHttpConfig, InitializedTransferEngine,
    MooncakeClient, OffloadTaskItem, PromotionTaskItem, ReplicaScorer, ReplicaSelectionPolicy,
