...
pub(super) struct Args {
    ...
    #[arg(long, default_value = "0.0.0.0")]
    pub(super) http_metadata_server_host: String,

    /// HTTP metadata 服务监听端口 / HTTP metadata server port
    #[arg(long, default_value_t = 8080)]
    pub(super) http_metadata_server_port: u16,
    ...
    pub(super) rpc_thread_num: usize,
    ...
    pub(super) nof_heartbeat_interval_sec: u64,
    ...
    pub(super) nof_heartbeat_probe_timeout_ms: u64,
    ...
    #[arg(long)]
    pub(super) ha_backend_connstring: Option<String>,
    ...
    pub(super) snapshot_interval_seconds: u64,
    ...
    pub(super) snapshot_child_timeout_seconds: u64,
    ...
    pub(super) snapshot_retention_count: u64,

    /// HA lease TTL in seconds
    /// HA 租约 TTL，单位秒
    #[arg(long, default_value_t = 30)]
    pub(super) ha_lease_ttl_secs: i64,
}
